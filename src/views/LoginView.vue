...
<template>
  <div class="min-h-[calc(100dvh-4rem)] flex items-center justify-center py-8 sm:py-12 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-zinc-950 via-[var(--bg-primary)] to-[var(--bg-primary)]">
    <div class="max-w-md w-full space-y-6 sm:space-y-8 bg-zinc-900/90 p-6 sm:p-8 rounded-2xl border border-zinc-800 shadow-xl relative overflow-hidden">
      <!-- Glow effect -->
      ...
      <div class="text-center text-xs text-zinc-400 pt-2">
        ...
        <router-link to="/register" class="font-medium text-blue-400 hover:underline flex items-center justify-center gap-1 mt-1">
